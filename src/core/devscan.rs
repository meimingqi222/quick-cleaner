...
mod tests {
    ...
    fn cachedir_tag_requires_valid_signature() {
        let tmp = crate::core::testing::fixture("qc_cachedir_sig");
    ...
    fn discovers_marked_dirs_and_skips_unmarked_lookalikes() {
        let base = crate::core::testing::fixture("qc_devscan_test");
    ...
    fn does_not_descend_into_a_matched_directory() {
        let base = crate::core::testing::fixture("qc_devscan_nested");
        let _ = std::fs::remove_dir_all(&base);
    ...
    fn collect_tree_finds_same_markers_as_collect() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_tree_test");
        let _ = std::fs::remove_dir_all(&base);
    ...
    fn incremental_refresh_removes_deleted_file_from_small_directory() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_incremental_delete");
    ...
    fn must_rescan_path_is_refreshed_without_any_detail_event() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_must_rescan_subtree");
    ...
    fn background_watermark_advance_never_triggers_full_rebuild() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_background_budget");
        let _ = std::fs::remove_dir_all(&base);
    ...
    fn must_rescan_on_volume_root_falls_back_to_full_scan() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_must_rescan_root");
        let _ = std::fs::remove_dir_all(&base);
    ...
    fn nested_change_roots_collapse_into_their_ancestor() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_root_collapse");
    ...
    fn incremental_refresh_skips_benign_root_event() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_root_event");
        let _ = std::fs::remove_dir_all(&base);
        std::fs::create_dir_all(&base).unwrap();
        let live = AtomicBool::new(true);
        let volume = VolumeId::from_mount_point(base.clone());
    ...
    fn incremental_refresh_skips_metadata_errors() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_metadata_error");
        let _ = std::fs::remove_dir_all(&base);
        std::fs::create_dir_all(&base).unwrap();
        let live = AtomicBool::new(true);
        let volume = VolumeId::from_mount_point(base.clone());
    ...
    fn incremental_refresh_updates_file_without_rescanning_parent() {
        ...
        let base = crate::core::testing::fixture("qc_devscan_incremental_file");
